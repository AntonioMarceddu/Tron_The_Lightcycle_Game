...
###Introduction
TRON LightCycle the Game is a game made for the examination of Graphics Engineering of Politecnico di Torino by Antonio Marceddu. The programming part and a fraction of the graphic part has been realized in OpenGL with the addition of GLUT, Assimp and Devil libraries, while the remaining fraction (realization of lightcycles) has been realized with Blender. This guide has the objective to explicate and motivate implementation choices of the project for educational purposes without talking too much of the code, as it is all commented in Italian language.
